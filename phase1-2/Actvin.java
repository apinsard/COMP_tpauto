public class Actvin {
  ...
  private static String formatLine(String[] columns) {
    String line = "\t";
    for (int i=0; i < columns.length; i++)
      line += chaineCadrageGauche(columns[i]);
    return line;
  }
  ...
  public static void executer(int numact) {
    switch (numact) {
      ...
      case  8  : // fin de fiche
                  ...
                  String[] line = {"CHAUFFEUR", "BJ", "BG", "ORD", "NBMAG"};
                  System.out.println(formatLine(line));
                  for (int c=0; c<=curChauf; c++) {
                    Chauffeur chauf = tabchauf[c];
                    line[0] = chauf.name;
                    line[1] = ""+chauf.bj;
                    line[2] = ""+chauf.bg;
                    line[3] = ""+chauf.ordin;
                    line[4] = ""+chauf.magdif.size();
                    System.out.println(formatLine(line));
                  }
                  break ;
      case  9  : // fin
